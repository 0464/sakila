...
public class FilmListService {
	...
	// 영화 검색 메서드
	public ArrayList<Film> getFilmSearchList(int beginRow, int rowPerPage, String search) {
		ArrayList<Film> returnList = null;
		...
		try {
			...
			// 쿼리 실행
			returnList = filmListDao.selectFilmSearchList(conn, beginRow, rowPerPage, search);
	...
	public int countSearchFilmList(String search) {
		...
		try {
			...
			// 쿼리 실행
			count = filmListDao.countSearchFilmList(conn, search);
